...
<font size="4"> Dylan J. Padilla Perez, 2023. Geographic and seasonal variation of the *for* gene reveal signatures of local adaptation in *Drosophila melanogaster*.</font>
</p>
...
```
<p align = "justify">
<font size="4"> **Figure 6.** Patterns of isolation by distance and isolation by environment according to Multiple Matrix Regression with Randomization analysis (MMRR). (a-b) Geographic and precipitation distances as a function of genetic distance in European populations of *D. melanogaster*. Colors represent estimated probability densities. </font>
</p>
<br><br>
