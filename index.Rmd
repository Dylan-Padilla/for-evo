...
```
<p align = "justify">
<font size="4"> **Figure 4.** Constrained correspondence analysis depicting the spatial distribution of populations based on the effect of seasons. The polygons drawn represent the confidence regions for the locations of group centroids. </font>
</p>
<br><br>
